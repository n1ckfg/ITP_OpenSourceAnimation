...
if((day>=1&&month>=1)||month>1){  //4 jan 12
$("#day1").show();
openThis=11;
}
if((day>=11&&month>=1)||month>1){  //11 jan 12
$("#day2").show();
openThis=10;
}
if((day>=18&&month>=1)||month>1){  //18 jan 12
$("#day3").show();
openThis=9;
}
if((day>=25&&month>=1)||month>1){  //25 jan 12
$("#day4").show();
openThis=8;
}
if((day>=1&&month>=2)||month>2){  //1 feb 12
$("#day5").show();
openThis=7;
}
if((day>=8&&month>=2)||month>2){  //8 feb 12
$("#day6").show();
openThis=6;
}
if((day>=15&&month>=2)||month>2){  //15 feb 12
$("#day7").show();
openThis=5;
}
if((day>=29&&month>=2)||month>2){  //29 feb 12
$("#day8").show();
openThis=4;
}
if((day>=7&&month>=3)||month>3){  //7 mar 12
$("#day9").show();
openThis=3;
}
if((day>=14&&month>=3)||month>3){  //14 mar 12
$("#day10").show();
openThis=2;
}
if((day>=21&&month>=3)||month>3){  //21 mar 12
$("#day11").show();
openThis=1;
}
if((day>=28&&month>=3)||month>3){  //28 mar 12
$("#day12").show();
openThis=0;
}
